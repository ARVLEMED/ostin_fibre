...
const Hero = () => {
  ...
  useEffect(() => {
    // Get last viewed index from memory (not localStorage)
    const lastIndex = window.sessionImageIndex || 0;
    ...
    const interval = setInterval(() => {
      setCurrentImageIndex((prevIndex) => {
        ...
        window.sessionImageIndex = newIndex; // Store in memory
        return newIndex;
      });
    }, 5000);
  ...
  const goToSlide = (index) => {
    ...
    window.sessionImageIndex = index;
  };

  return (
    <section id="home" className="bg-white min-h-screen flex flex-col relative overflow-hidden">
      {/* Top section with decorative circles and carousel */}
      <div className="relative w-full py-8 sm:py-12 md:py-16">
        {/* Top-left Purple Circle */}
        <div
          className="absolute top-0 left-0 w-[200px] h-[200px] sm:w-[280px] sm:h-[280px] lg:w-[400px] lg:h-[400px] rounded-full transform -translate-x-1/3 -translate-y-1/3 z-0"
          style={{ backgroundColor: '#251464' }}
        ></div>

        {/* Top-right Purple Circle */}
        <div
          className="absolute top-0 right-0 w-[100px] h-[100px] sm:w-[160px] sm:h-[160px] lg:w-[240px] lg:h-[240px] rounded-full transform translate-x-12 sm:translate-x-20 lg:translate-x-24 -translate-y-16 sm:-translate-y-20 lg:-translate-y-24 z-0"
          style={{ backgroundColor: '#251464' }}
        ></div>

        {/* Image Carousel - Centered between circles */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="relative w-full h-48 sm:h-64 md:h-80 overflow-hidden rounded-2xl shadow-2xl">
      ...
      {/* Main hero content with decorative circles */}
      <div className="flex-1 relative overflow-hidden">
        ...
        {/* Hero content */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 text-center relative z-10 py-8 sm:py-12">
          <div className="max-w-4xl mx-auto">
            {/* Tagline bubble */}
            <div
